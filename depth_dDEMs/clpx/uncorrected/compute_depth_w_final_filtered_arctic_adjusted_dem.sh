...
gdal_calc.py -A ../../../DEMs/clpx/snow_surface/clpx_snow_on_105_2018.tif -B ../../../DEMs/clpx/bare_earth/clpx_dem_final_minus_014m_filtered.tif --outfile=clpx_depth_from_filtered_and_arctic_adjusted_DEM_105_2018.tif --calc="A-B" --NoDataValue=-9999

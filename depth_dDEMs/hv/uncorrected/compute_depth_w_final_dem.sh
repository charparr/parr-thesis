...
gdal_calc.py -A ../../../DEMs/hv/snow_surface/hv_snow_on_103_2018.tif -B ../../../DEMs/hv/bare_earth/hv_dem_final.tif --outfile=hv_depth_103_2018.tif --calc="A-B" --NoDataValue=-9999

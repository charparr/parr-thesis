...
gdal_calc.py -A ../../../DEMs/hv/snow_surface/hv_snow_on_102_2017.tif -B ../../../DEMs/hv/bare_earth/hv_dem_final_filtered.tif --outfile=hv_depth_from_filtered_DEM_102_2017.tif --calc="A-B" --NoDataValue=-9999

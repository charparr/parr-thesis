...
import whitebox
import os
from whitebox_tools_dict import wb_tools_in_dict
...
# Compute slope first bc it is needed for other computations:
outname = prefix + "slope.tif"
getattr(wbt, 'slope')(full_dem_path, os.path.join(out_dir, outname))
...
# Try pit-filled / smoothed DEMS
# Not as helpful
## sediment_transport, wetness, d8_flow_acc
